      ...
      >
        <div className="flex justify-between items-center mb-6">
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1 capitalize">{task.status.replace('_', ' ')}</p>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="space-y-5">
          <div className="grid grid-cols-2 gap-4">
            <div className="flex items-center space-x-2 p-3 bg-gray-50 rounded-lg">
              ...
              <div>
                ...
                <p className="text-sm font-medium text-gray-900 capitalize">{task.priority}</p>
              </div>
            </div>
          ...
          <div className="flex items-center space-x-2 p-3 bg-gray-50 rounded-lg">
            ...
            <div>
              ...
              <p className="text-sm font-medium text-gray-900">{task.estimatedDuration || "Not specified"}</p>
            </div>
          </div>
          ...
          {task.volunteers && task.volunteers.length > 0 && (
            <div className="border-t pt-5">
              <h4 className="text-sm font-medium text-gray-900 mb-3">Current Volunteers</h4>
              <div className="space-y-3">
                {task.volunteers.map((volunteer) => (
                  <div key={volunteer._id} className="flex items-center space-x-2 p-3 bg-gray-50 rounded-lg">
